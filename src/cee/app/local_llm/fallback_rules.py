...
IDENTITY_REPLY = """我是空间认知涌现引擎(Cognitive Emergence Engine)，v4.0。

一个完全本地运行的 AI 对话系统，基于六大认知引擎(T1-T6)和自学习知识库，不需要任何外部 API 或付费服务。
...
我会分析你的具体需求，然后推荐最适合的工具。能告诉我更多关于你的使用场景吗？比如：
- 用在什么项目上？
- 对性能有什么要求？
- 是否需要团队协作？"""
        ),
...
免费的优质资源有很多，你想从哪个方向开始？""",
    ...
    "创意": {
        ...
        "reply": """让我用 T5 反事实生长引擎来帮你激发创意：

核心思路是突破常规假设，从完全不同的角度重新审视问题。
